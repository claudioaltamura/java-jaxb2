...
public class Order {
    ...
    @XmlElement(required = true)
    protected Order.ShipToAddress shipToAddress;
    @XmlElement(name = "item", required = true)
    protected List<Order.Item> items;
    ...
    /**
     * Ruft den Wert der shipToAddress-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link Order.ShipToAddress }
     *     
     */
    public Order.ShipToAddress getShipToAddress() {
        return shipToAddress;
    }

    /**
     * Legt den Wert der shipToAddress-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link Order.ShipToAddress }
     *     
     */
    public void setShipToAddress(Order.ShipToAddress value) {
